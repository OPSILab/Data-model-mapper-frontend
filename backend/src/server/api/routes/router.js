...
const { minio, getConfig, insertMap, dereferenceSchema, insertSource, insertDataModel, mapData, getMap, getSource, getDataModel, getMaps, getSources, getDataModels, modifyMap, modifySource, modifyDataModel, deleteMap, deleteSource, deleteDataModel, file } = require("../controllers/controller.js")
...
router.post(encodeURI("/minio/datamodelmapper"), minio)
router.post(encodeURI("/datamodelmapper"), minio)
...
router.get(encodeURI("/minio/datamodelmapper"), minio)
router.get(encodeURI("/datamodelmapper"), minio)
...
router.put(encodeURI("/minio/datamodelmapper"), minio)
router.put(encodeURI("/datamodelmapper"), minio)
